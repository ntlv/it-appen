...
public class DataCollectorMechanism extends IntentService {
    ...
    private static final char SCHEDULE_EVENT_STRING_DELIMITER_CHARACTER = ',';
    ...
    public void onCreate() {
        ...
        mBoardJsObjRequest = new JsonArrayRequest(url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(getApplicationContext(), "Kunde inte ansluta till internet.", Toast.LENGTH_SHORT).show();
            }
    ...
    private void insertBoardMembers(JSONArray resultArray) {
        ...
        try {
            ...
            // TODO figure out how to recover, if possible
            e.printStackTrace();
        }
    ...
    class ScheduleGrabber {
        ...
        final int COURSE_NAME_COLUMN = 4; // namn på kursen
        final int PROGRAM_NAMES = 5; // inblandade program
        // final int EQUIPMENT_COLUMN = 6;
        ...
        final int SIZE_OF_SCHEDULE_OBJECTS = 12 ;
        ...
        private String[] splitByComma(String line) {
            ...
            String[] result = new String[SIZE_OF_SCHEDULE_OBJECTS];
            ...
            if(line.lastIndexOf(',') != line.length() - 1){
                line += SCHEDULE_EVENT_STRING_DELIMITER_CHARACTER;
            }
